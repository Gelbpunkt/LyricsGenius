...
class Artist(object):
    ...
    def get_song(self, song_name):
        ...
        raise NotImplementedError(
            "I need to figure out how to allow Artist() to access Genius.search_song()."
        )
        # song = Genius.search_song(song_name, self.name)
        # self.add_song(song)
        # return

    def to_json(self, filename=None, sanitize=True):
        """
